...
@section('landingPageIntro')
    ...
    @endif
    <br>
    See a topic you like? Select the link for that topic and add your .02. <br>
    Don't see a topic that catches your interest? Select the Create a Topic link and begin. 
@stop
